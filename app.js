...
const getWinner = (cChoice, pChoice = DEAFULT_USER_CHOICE) =>
  cChoice === pChoice ?
  RESULT_DRAW :
...
startGameBtn.addEventListener("click", () => {
  ...
  let message = `You picked ${playerChoice || DEAFULT_USER_CHOICE}, computer picked ${computerChoice}, so you `;
...
combine(showResult.bind(this, "The result after adding number is: "), "ADD", 1, 5, 'fdsa', -3, 6, 10);
combine(showResult.bind(this, "The result after adding number is: "), "ADD", 1, 5, 10, -3, 6, 10, 25, 88);
